...
| Grafana | `kubectl port-forward svc/kube-prometheus-stack-grafana -n monitoring 3000:80` → http://localhost:3000 | Not exposed externally — the brief doesn't ask for it, unlike Rancher/Argo CD/Harbor. Port-forward is sufficient for dashboard review. |
